...
In this project, I have investigated policies of US presidential candidates in the 2024 election. I have created word clouds from Harris and Trump's policy documents that shows their views and reveals what issues they are focusing on.
...
```
The word "small" is used with business. We already have the phrase "small_businesses" as a single token. I will transform the word "business" into "businesses" so that it will be considered part of the token "small_businesses".  
